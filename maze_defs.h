#ifndef COP_2001_CLION_MAZEDEFS_H
#define COP_2001_CLION_MAZEDEFS_H

#endif //COP_2001_CLION_MAZEDEFS_H
...
// bit masks for directions/wall segements
...
struct Maze {
    ...
    <<change_me>>;      // collection of cells
};

// data structure for an animated mouse that walks through
// the maze following a predetermined seach pattern
// --------------------------------------------------------
struct Mouse {
