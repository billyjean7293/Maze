...
sf::RectangleShape *
buildRectangle(float centerX, float centerY, float width, float height, sf::Color fillColor = sf::Color::Cyan,
               float rotation = 0.f);
...
// create a new cell
            ...
            if (walls & EAST)
                cell.eastWall = buildRectangle(cellX + CELL_SIZE / 2.f, cellY, CELL_SIZE, WALL_THICKNESS, WALL_COLOR,
                                               90.f);
            ...
            if (walls & WEST)
                cell.westWall = buildRectangle(cellX - CELL_SIZE / 2.f, cellY, CELL_SIZE, WALL_THICKNESS, WALL_COLOR,
                                               90.f);
 ...
 */
sf::RectangleShape *
buildRectangle(float centerX, float centerY, float width, float height, sf::Color fillColor, float rotation) {
...
// see if the mouse has completed its turn
    ...
    if (finishedTurning) {
        ...
        mouse.speedTurning = 0.f;           // stop turnning the mouse graphically
    }
